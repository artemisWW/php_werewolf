...
$user_size = 0;
foreach ($role_size_map as $role_id => $role_size) {
    $user_size += $role_size;
}

$state0 = new State($role_size_map);
$state0->init();
$state1 = new State($role_size_map);
$state1->init();
...
//$state0->action(3, "COMINGOUT 占");
$state0->action(4, "COMINGOUT 占");
$state0->action(2, "DIVINED 0 false");
//$state0->action(3, "DIVINED 0 true");
//$state0->action(4, "DIVINED 0 true");

$state1->action(2, "COMINGOUT 占");
//$state1->action(3, "COMINGOUT 占");
$state1->action(4, "COMINGOUT 占");
$state1->action(2, "DIVINED 0 false");
//$state1->action(3, "DIVINED 0 true");
//$state1->action(4, "DIVINED 0 true");
